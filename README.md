...
[![Launch on Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/GLAM-Workbench/trove-government/master/?urlpath=lab/tree/index.ipynb)
...
[![Launch on Reclaim Cloud](https://glam-workbench.github.io/images/launch-on-reclaim-cloud.svg)](https://app.my.reclaim.cloud/?manifest=https://raw.githubusercontent.com/GLAM-Workbench/trove-government/master/reclaim-manifest.jps)
...
* From the command line, run the following command:  
  ```
  docker run -p 8888:8888 --name trove-government -v "$PWD":/home/jovyan/work quay.io/glamworkbench/trove-government repo2docker-entrypoint jupyter lab --ip 0.0.0.0 --NotebookApp.token='' --LabApp.default_url='/lab/tree/index.ipynb'
  ```
...
* Create a virtual environment, eg: `python -m venv trove-government`
* Open the new directory" `cd trove-government`
* Activate the environment `source bin/activate`
* Clone the repository: `git clone https://github.com/GLAM-Workbench/trove-government.git notebooks`
